...
class GoogleSpeechRecognitionService:
        ...
        with self.microphone as source:
            ...
            while self.is_listening:
                try:
                    ...
                    audio_chunk = self.recognizer.listen(source, timeout=1, phrase_time_limit=5)
    ...
    def transcribe_audio(self):
        ...
        for audio_chunk in self.audio_data:
            try:
                ...
                logger.warning("Google Speech Recognition could not understand audio chunk.")
    ...
    def reset(self):
        self.is_listening = True
        self.audio_data = []
        logger.info("Google Speech Recognition Service has been reset for a new session.")
