from os_assistant.core.states.os_assistant_state import OSAssistantState, ClassificationState
from os_assistant.prompts.query_classification import get_query_classification_sys_prompt
...
def query_classification_node(state: OSAssistantState) -> OSAssistantState:
    ...
    response = llm_model.generate_response(
        ...
        structured_output=ClassificationState
    )
